package org.example.financiai_final_front.financiai.dao;
...
import org.example.financiai_final_front.financiai.util.Conexao;
...
public class ImovelDAO {
    ...
    public void adicionarImovel(Imovel imovel) {
        ...
        try (PreparedStatement stmt = conexao.prepareStatement(sql)) {
            ...
            throw new RuntimeException("Erro ao adicionar imovel: " + e.getMessage(), e);
        }
    }
    ...
    public List<Imovel> listarImoveis() {
        ...
        try (PreparedStatement stmt = conexao.prepareStatement(sql);
            ...
            throw new RuntimeException("Erro ao listar imoveis: " + e.getMessage(), e);
        }
        return imoveis;
    }
